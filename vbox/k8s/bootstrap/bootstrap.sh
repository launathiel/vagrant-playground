...
cat >>/etc/hosts<<EOF
172.16.10.100 kmaster.example.com kmaster
172.16.10.101 kworker1.example.com kworker1
172.16.10.102 kworker2.example.com kworker2
EOF
...
# Add sysctl settings
echo "[TASK 6] Add modules-load settings"
...
echo "[TASK 9] Installing apt-transport-https pkg"
...
apt-get install -y kubeadm=1.21.9-00 kubelet=1.21.9-00 kubectl=1.21.9-00
